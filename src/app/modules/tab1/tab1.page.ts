            ...
            bluetoothle.initializePeripheral(
                initRes => {
                    ...
                    bluetoothle.addService(
                        succResp => {
                            console.error('BLC success', succResp);
                        },
                        errResp => {
                            console.error('BLC', 'error', errResp);
                        },
                        serviceParams
                    );
                    ...
                    bluetoothle.startAdvertising(
                        succResp => {
                            console.error('BLC ADV success', succResp);
                        },
                        errResp => {
                            console.error('BLC ADV error', errResp);
                        },
                        advertParams
                    );
                },
                errResp => {
                    console.error('BLC PERI error', errResp);
                },
                initPeriParams
            );
        });
